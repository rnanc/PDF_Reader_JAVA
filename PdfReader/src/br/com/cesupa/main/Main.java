...
public class Main {
	...
	public static void main(String[] args) throws IOException, TesseractException {
		...
		//USA TEXT EXTRACT
		 ...
		 instance.setDatapath("D:\\Codigos\\Java\\iaGroupWorkspace\\PDF_Reader_JAVA\\PdfReader\\tessdata");
		 try { 
			//text = getText(new File("D:\\Downloads\\Processo_0000315-12.2018.5.08.0208.pdf"));
			//System.out.println(text); 
			 PDDocument doc = PDDocument.load(new File("D:\\Downloads\\Processo_0000315-12.2018.5.08.0208.pdf"));
